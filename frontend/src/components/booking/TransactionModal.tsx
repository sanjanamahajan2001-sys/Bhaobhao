...
import { Transaction } from '@/types/bookingHistory.type';
...
//           <p className="text-base font-semibold text-green-600">₹{paid}</p>
//         </div>
//         <div>
//           <p className="text-xs text-gray-500">Pending</p>
//           <p className="text-base font-semibold text-red-600">₹{balance}</p>
//         </div>
//       </div>

//       <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
//         <div
//           className={`h-2 ${fullyPaid ? 'bg-green-500' : 'bg-orange-500'}`}
//           style={{ width: `${Math.min((paid / total) * 100, 100)}%` }}
//         />
//       </div>
